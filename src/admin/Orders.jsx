...
const Orders = () => {
	...
	const showOrdersLength = () => {
		if (orders.length > 0) {
			return <h2 className='text-danger text-center'>Total Orders: {orders.length}</h2>;
		} else {
			return <h2 className='text-danger text-center'>No Orders</h2>;
		}
	};
	...
	const showStatus = o => (
		<div className='form-group'>
			<h5 className='mb-4'>Order Status: {o.status}</h5>
					...
					{orders.map((o, oIndex) => {
						return (
							<div
								...
								<h4 className='mb-3'>
									<span style={{ border: '3px solid black' }}>Order ID: {o._id}</span>
								</h4>
